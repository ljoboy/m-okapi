...
class Exercice_budgetaire_model extends CI_Model
{

    public $table = 'exercice_budgetaire';
    public $id = 'id';
    public $order = 'DESC';
    ...
    // datatables
    function json() {
        $this->datatables->select('id,id_utilisateur,date_debut,date_fin,budget_initial,date_creation');
	...
	$this->db->or_like('budget_initial', $q);

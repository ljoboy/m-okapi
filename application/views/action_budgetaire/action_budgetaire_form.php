<h2>Action_budgetaire <?php echo $button ?></h2>
<form action="<?php echo $action; ?>" method="post">
	<div class="form-group">
		<label for="int">Id Sortie <?php echo form_error('id_sortie') ?></label>
		<input type="text" class="form-control" name="id_sortie" id="id_sortie" placeholder="Id Sortie"
			   value="<?php echo $id_sortie; ?>"/>
	</div>
	<div class="form-group">
		<label for="double">Montant Utilise <?php echo form_error('montant_utilise') ?></label>
		<input type="text" class="form-control" name="montant_utilise" id="montant_utilise"
			   placeholder="Montant Utilise" value="<?php echo $montant_utilise; ?>"/>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="date_creation" id="date_creation" placeholder="Date Creation"
